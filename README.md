...
* Comandos para pruebas relacionadas con vitest (ejecutar desde el directorio front/):
  ...
  - Para pruebas e2e (ejemplo: Login.tests.ts): npx vitest run tests/e2e/Login.tests.ts
  - Para pruebas con selenium (ejemplo: index.tests.js): node front/tests/selenium/index.tests.js
